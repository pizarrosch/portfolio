  ...
  return (
    <Layout>
      <div className={s.root}>
        <ProjectItem src={todoListImg} title='Todo list'
                     description='My first React project. A quite simple todo list has been a challenge in the beginning. But it also has been a great opportunity to get to know React'/>
        <ProjectItem src={weatherWidgetPjImg} title='Weather Widget'
        ...
        <ProjectItem src={kanbanPjImg} title='Kanban Board'
