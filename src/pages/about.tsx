        ...
        <Layout>
            <div className={s.root}>
                ...
                <div className={s.aboutMeWrapper}>
                    ...
                    <article>
                        <p>
                            My name is Zaur. I am a chemist who one day wanted to change <br/> his profession to that of
                            a
                        ...
                        <p>
                            Feel free to click on the Projects button on the navigation menu to <br/> look into some of
                            my
                            projects.
                        </p>
                    </article>
